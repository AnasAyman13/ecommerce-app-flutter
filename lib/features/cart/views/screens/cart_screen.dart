...
class _CartScreenState extends State<CartScreen> {
  ...
  final TextEditingController _promoController = TextEditingController(text: 'NORR15');
  ...
  double get promoDiscount => 378.0;
  double get estimatedTax => 168.0;
  double get grandTotal => subtotal - promoDiscount + estimatedTax;
